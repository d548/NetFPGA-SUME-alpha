 ...
 *
 * File:
 *     sw/embedded/src/nf_sume_pcie/helloworld.c
 *
 * Project:
 *     acceptance_test
 *
...
void runManualTest(void) {
	...
	while(1) {
		...
		xil_printf("s: Read PCIE Test Status\r\n");
...
int main()
{
	...
	xil_printf("NetFPGA-SUME PCIE Acceptance Test\r\n");
