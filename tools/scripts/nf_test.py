...
def handleArgs():
    ...
    if args.type == 'sim':
        ...
        if args.make_file or args.make_opt or args.sim_opt or args.dump or args.vcs or args.vsim or args.isim or args.gui or args.no_compile or args.compile_only:
            print 'Error: --make_file, --make_opt, --sim_opt, --dump, --vcs, --vsim --isim, and --gui are only compatible with simulation tests'
            sys.exit(1)
