...
proc create_hier_cell_dma_sub { parentCell nameHier } {
 ...
 # set_property -dict [list CONFIG.SYNCHRONIZATION_STAGES.VALUE_SRC USER] [get_bd_cells dma_sub/axi_interconnect_0] 
 ...
 # # reset conversion through util_vector_logic 
 # # AXI-Lite: axi_lite_areset (axi_lite_aclk)
 # set axi_lite_rst_inv [create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic axi_lite_rst_inv]
 # set_property -dict [list CONFIG.C_SIZE {1} CONFIG.C_OPERATION {not}] [get_bd_cells axi_lite_rst_inv]
  
#  # AXIS: clock domain crossing FIFO, RX (FPGA->PCIe) axis_datapath_areset (axis_datapath_aclk)
#  set axis_rx_rst_inv [create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic axis_rx_rst_inv]
#  set_property -dict [list CONFIG.C_SIZE {1} CONFIG.C_OPERATION {not}] [get_bd_cells axis_rx_rst_inv]
...
connect_bd_net -net M09_ACLK_i [get_bd_pins M09_ACLK] [get_bd_pins axi_interconnect_0/M09_ACLK] 
    # axi-lite rst - will be connected to axi_interconnect through inverter
#  connect_bd_net -net axi_lite_rst_1 [get_bd_pins axi_lite_areset] [get_bd_pins axi_lite_rst_inv/Op1]
...
connect_bd_net -net M09_ARESETN_i [get_bd_pins M09_ARESETN]  [get_bd_pins axi_interconnect_0/M09_ARESETN]
 ...
 # connect_bd_net -net axis_10g_clk_1 [get_bd_pins axis_datapath_aclk] [get_bd_pins axis_fifo_10g_rx/s_axis_aclk] [get_bd_pins axis_dwidth_dma_rx/aclk] [get_bd_pins axis_dwidth_dma_tx/aclk] [get_bd_pins axis_fifo_10g_tx/m_axis_aclk] [get_bd_pins axi_interconnect_0/ACLK]
...
#connect_bd_net -net axis_10g_rstnu_1 [get_bd_pins axis_datapath_areset] [get_bd_pins axis_rx_rst_inv/Op1] 

  #connect_bd_net -net axis_rx_sys_reset_0_peripheral_aresetn [get_bd_pins axis_fifo_10g_rx/s_axis_aresetn] [get_bd_pins axis_dwidth_dma_tx/aresetn] [get_bd_pins axis_dwidth_dma_rx/aresetn] [get_bd_pins axis_fifo_10g_tx/m_axis_aresetn] [get_bd_pins axis_datapath_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] 
  ...
  #connect_bd_net -net axis_tx_sys_reset_0_peripheral_aresetn [get_bd_pins axis_fifo_10g_tx/s_axis_aresetn]  [get_bd_pins axis_fifo_10g_rx/m_axis_aresetn] [get_bd_pins pcie_reset_inv/Res]
  ...
  #connect_bd_net -net pcie3_7x_1_user_clk [get_bd_pins axis_fifo_10g_rx/m_axis_aclk] [get_bd_pins axis_fifo_10g_tx/s_axis_aclk] [get_bd_pins nf_riffa_dma_1/user_clk] [get_bd_pins pcie3_7x_1/user_clk]
...
#  set_property -dict [ list CONFIG.FREQ_HZ {100000000}  ] $M00_ACLK
#  set M00_ARESETN [ create_bd_port -dir I -type rst M00_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M00_ARESETN 
#  set M01_ACLK [ create_bd_port -dir I -type clk M01_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M01_ACLK
#  set M01_ARESETN [ create_bd_port -dir I -type rst M01_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M01_ARESETN  
#set M02_ACLK [ create_bd_port -dir I -type clk M02_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M02_ACLK
#  set M02_ARESETN [ create_bd_port -dir I -type rst M02_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M02_ARESETN
#set M03_ACLK [ create_bd_port -dir I -type clk M03_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M03_ACLK
#  set M03_ARESETN [ create_bd_port -dir I -type rst M03_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M03_ARESETN 
#set M04_ACLK [ create_bd_port -dir I -type clk M04_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M04_ACLK
#  set M04_ARESETN [ create_bd_port -dir I -type rst M04_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M04_ARESETN 
#set M05_ACLK [ create_bd_port -dir I -type clk M05_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M05_ACLK
#  set M05_ARESETN [ create_bd_port -dir I -type rst M05_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M05_ARESETN 
#set M06_ACLK [ create_bd_port -dir I -type clk M06_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M06_ACLK
#  set M06_ARESETN [ create_bd_port -dir I -type rst M06_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M06_ARESETN 
#set M07_ACLK [ create_bd_port -dir I -type clk M07_ACLK ]
#  set_property -dict [ list CONFIG.FREQ_HZ {200000000}  ] $M07_ACLK
#  set M07_ARESETN [ create_bd_port -dir I -type rst M07_ARESETN ]
#  set_property -dict [ list CONFIG.POLARITY {ACTIVE_LOW}] $M07_ARESETN 
...
#  connect_bd_net -net M00_ARESETN_1 [get_bd_pins M00_ARESETN]  [get_bd_pins dma_sub/M00_ARESETN] 
#  connect_bd_net -net M01_ARESETN_1 [get_bd_pins M01_ARESETN]  [get_bd_pins dma_sub/M01_ARESETN]
#  connect_bd_net -net M02_ARESETN_1 [get_bd_pins M02_ARESETN]  [get_bd_pins dma_sub/M02_ARESETN]
#  connect_bd_net -net M03_ARESETN_1 [get_bd_pins M03_ARESETN]  [get_bd_pins dma_sub/M03_ARESETN]
#  connect_bd_net -net M04_ARESETN_1 [get_bd_pins M04_ARESETN]  [get_bd_pins dma_sub/M04_ARESETN]
#  connect_bd_net -net M05_ARESETN_1 [get_bd_pins M05_ARESETN]  [get_bd_pins dma_sub/M05_ARESETN]
#  connect_bd_net -net M06_ARESETN_1 [get_bd_pins M06_ARESETN]  [get_bd_pins dma_sub/M06_ARESETN] 
#  connect_bd_net -net M07_ARESETN_1 [get_bd_pins M07_ARESETN]  [get_bd_pins dma_sub/M07_ARESETN]
#  
#  connect_bd_net -net M00_ACLK_1 [get_bd_pins M00_ACLK] [get_bd_pins dma_sub/M00_ACLK] 
#  connect_bd_net -net M01_ACLK_1 [get_bd_pins M01_ACLK] [get_bd_pins dma_sub/M01_ACLK] 
#  connect_bd_net -net M02_ACLK_1 [get_bd_pins M02_ACLK] [get_bd_pins dma_sub/M02_ACLK]
#  connect_bd_net -net M03_ACLK_1 [get_bd_pins M03_ACLK] [get_bd_pins dma_sub/M03_ACLK]
#  connect_bd_net -net M04_ACLK_1 [get_bd_pins M04_ACLK] [get_bd_pins dma_sub/M04_ACLK] 
#  connect_bd_net -net M05_ACLK_1 [get_bd_pins M05_ACLK] [get_bd_pins dma_sub/M05_ACLK] 
#  connect_bd_net -net M06_ACLK_1 [get_bd_pins M06_ACLK] [get_bd_pins dma_sub/M06_ACLK] 
#  connect_bd_net -net M07_ACLK_1 [get_bd_pins M07_ACLK] [get_bd_pins dma_sub/M07_ACLK] 
