...
set ip_name				{d_clkfreq_detector}
set lib_name 			{digilent}
set vendor_name 		{digilent}
set ip_display_name 	{Clock Frequency Detector}
set ip_description	 	{Clock Frequency Detector}
...
# Top Module Name
set top_module_name {d_clkfreq_detector}
...
array set visible_parameter_list {
	C_AXI_CLK_FREQ {
		page {Page 0}\
		name {C_AXI_CLK_FREQ}\
		display_name {AXI Clock Frequency}\
		widget {default}\
	}
}
