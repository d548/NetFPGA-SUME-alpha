...
if isHW():
    ...
    rres1=nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_LUTMISS_0(), 0X14)
    rres2=nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_LUTHIT_0(), 0x0)
    mres=[rres1,rres2]
else:
    nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_LUTHIT_0(), 0) # lut_hit
    nftest_regread_expect(SUME_OUTPUT_PORT_LOOKUP_LUTMISS_0(), 0x14) # lut_miss
    mres=[]
