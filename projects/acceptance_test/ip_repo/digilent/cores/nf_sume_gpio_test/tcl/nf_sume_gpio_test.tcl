...
#
# File:
# nf_sume_gpio_test.tcl
#
# Library:
# hw/std/nf_sume_gpio_test
#
# Author:
# Tinghui Wang (Steve)
#
...
set ip_name				{nf_sume_gpio_test}
set lib_name 			{digilent}
set vendor_name 		{digilent}
set ip_display_name 	{NetFPGA-SUME Board GPIO Loopback Test}
set ip_description	 	{NetFPGA-SUME Board GPIO Loopback Test}
...
# Top Module Name
set top_module_name {nf_sume_gpio_test}
