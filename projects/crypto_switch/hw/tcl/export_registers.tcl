...
set DEF_LIST {
	...
	{NF_10G_INTERFACE0 0 1 nf_10g_interface_shared_v1_0_0/data/nf_10g_interface_shared_regs_defines.txt} \
	{NF_10G_INTERFACE1 1 1 nf_10g_interface_v1_0_0/data/nf_10g_interface_regs_defines.txt} \
...
# Add your module details in the DEF_LIST above, in the form
# {MODULE_NAME 0 1 ../../../../projects/PROJECT_NAME/hw/local_ip/CORE_NAME/data/CORE_NAME_regs_defines.txt} \
...
puts $h_file "//"
puts $h_file "// This software was developed by the University of Cambridge Computer Laboratory "
puts $h_file "// under EPSRC INTERNET Project EP/H040536/1, National Science Foundation under Grant No. CNS-0855268,"
puts $h_file "// and Defense Advanced Research Projects Agency (DARPA) and Air Force Research Laboratory (AFRL), "
puts $h_file "// under contract FA8750-11-C-0249."
puts $h_file "//"
