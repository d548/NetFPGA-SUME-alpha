...
#connect_bd_net [get_bd_ports axi_lite_aclk] [get_bd_pins axi_clock_converter_0/s_axi_aclk]
#connect_bd_net [get_bd_ports axi_lite_areset] [get_bd_pins axi_clock_converter_0/s_axi_aresetn]
#connect_bd_net -net [get_bd_nets core_clk_1] [get_bd_ports core_clk] [get_bd_pins axi_clock_converter_0/m_axi_aclk]
#connect_bd_net -net [get_bd_nets core_resetn_1] [get_bd_ports core_resetn] [get_bd_pins axi_clock_converter_0/m_axi_aresetn]
...
#  set_property offset $M07_BASEADDR [get_bd_addr_segs {S00_AXI/SEG_M07_AXI_Reg}]
#  set_property range $M07_SIZEADDR [get_bd_addr_segs {S00_AXI/SEG_M07_AXI_Reg}] 
