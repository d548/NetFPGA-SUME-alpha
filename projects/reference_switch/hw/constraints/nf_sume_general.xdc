...
## -- 200MHz & 100MHz clks
create_clock -period 5.000 -name clk_200 -add [get_pins -hier -filter name=~*axi_clocking_i*clk_200_bufg0/O]
create_clock -period 10.000 -name axi_clk -add [get_pins -hier -filter name=~*axi_lite_bufg0/O]
#create_clock -period 8.000 -name s_axi_aclk [get_pins -hier -filter name=~*axi_clocking_i*s_axi_aclk_bufg0/O]
