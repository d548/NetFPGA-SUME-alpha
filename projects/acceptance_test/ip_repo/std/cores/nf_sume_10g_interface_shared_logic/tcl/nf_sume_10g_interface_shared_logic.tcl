...
#
# File:
# nf_sume_10g_interface_shared_logic.tcl
#  
# Library:
...
set ip_name				{nf_sume_10g_interface_shared_logic}
set lib_name 			{digilent}
set vendor_name 		{digilent}
set ip_display_name 	{NetFPGA-SUME 10G Ethernet Interface Shared Logic}
set ip_description	 	{NetFPGA-SUME 10G Ethernet Interface Shared Logic}
