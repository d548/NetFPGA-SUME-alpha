 ...
 *
 * File:
 *     sw/embedded/src/nf_sume_qth_gtwizard/helloworld.c
 *
 * Project:
 *     acceptance_test
 *
 ...
 *
 * Description:
 *     main function for QTH GTwizard test
 *
...
void runManualTest(void) {
	...
	while(1) {
		...
		xil_printf("s: Read QTH Test Status\r\n");
...
int main()
{
	...
	Status = qthTest_Init();
	if (Status != XST_SUCCESS) {
		xil_printf("QTH Initialization FAILED\n\r");
		return XST_FAILURE;
	}
