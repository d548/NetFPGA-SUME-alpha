...
set_property -dict [list CONFIG.C_BASEADDR $OUTPUT_PORT_LOOKUP_BASEADDR] [get_ips nic_output_port_lookup_ip]
set_property -dict [list CONFIG.C_HIGHADDR $OUTPUT_PORT_LOOKUP_HIGHADDR] [get_ips nic_output_port_lookup_ip]
