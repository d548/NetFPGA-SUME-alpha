 ...
 *
 * File:
 *     sw/embedded/src/nf_sume_sata/helloworld.c
 *
 * Project:
 *     acceptance_test
 *
...
void runManualTest(void) {
	...
	while(1) {
		...
		xil_printf("s: Read SATA Test Status\r\n");
...
int main()
{
	...
	xil_printf("NetFPGA-SUME SATA Acceptance Test\r\n");
