 ...
 *
 * File:
 *     sw/embedded/src/nf_sume_fmc_gtwizard/helloworld.c
 *
 * Project:
 *     acceptance_test
 *
 ...
 *
 * Description:
 *     main function for FMC GTwizard test
 *
...
void runManualTest(void) {
	...
	while(1) {
		...
		xil_printf("s: Read FMC Test Status\r\n");
...
int main()
{
	...
	xil_printf("NetFPGA-SUME FMC Acceptance Test\r\n");
	...
	Status = fmcTest_Init();
	if (Status != XST_SUCCESS) {
		xil_printf("FMC Initialization FAILED\n\r");
		return XST_FAILURE;
	}
